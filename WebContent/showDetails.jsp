...
<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver"  url="jdbc:mysql://localhost/owasp"  user="root"  password="root"/>
     <sql:query dataSource="${db}" var="rs">  SELECT name , email,creditCardDetails from user where id = ? <sql:param value="${param.id}" />    ; </sql:query>
<c:forEach var="table" items="${rs.rows}">
 ...
 <table>
 		...
 		<tr><td>Credit Card Detail</td><td><c:out value="${table.creditCardDetails}"/></td></tr>
